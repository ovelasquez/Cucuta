...
/*-----------------------------------------------------------------------------------*/
	...
	function widget( $args, $instance ) {
		...
		global $sc_theme_globals, $bookyourtravel_car_rental_helper;
		...
		$car_rental_results = $bookyourtravel_car_rental_helper->list_car_rentals(1, $number_of_posts, $sort_by, $order, 0, $car_type_ids, $car_rental_tag_ids, array(), $show_featured_only);
...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number_of_posts' ) ); ?>"><?php esc_html_e('How many car_rentals do you want to display?', 'bookyourtravel') ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'sort_by' ) ); ?>"><?php esc_html_e('What do you want to sort the car_rentals by?', 'bookyourtravel') ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'sort_descending' ) ); ?>"><?php esc_html_e('Sort car_rentals in descending order?', 'bookyourtravel') ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_featured_only') ); ?>"><?php esc_html_e('Show only featured car_rentals?', 'bookyourtravel') ?></label>
		...
		<p>
			<label><?php esc_html_e('Car type (leave blank to ignore)', 'bookyourtravel') ?></label>
			<div>
		...
		<p class="cards" <?php echo ( $instance['display_mode'] != 'card' ? 'style="display:none"' : '' ); ?>>
			<label for="<?php echo esc_attr ( $this->get_field_id( 'posts_per_row' ) ); ?>"><?php esc_html_e('How many car_rentals do you want to display per row?', 'bookyourtravel') ?></label>
