...
do_action( 'bookyourtravel_show_accommodation_confirm_form_before' ); ?>
<form method="post" action="<?php echo BookYourTravel_Theme_Utils::get_current_page_url(); ?>" class="booking accommodation-confirmation-form" style="display:none">
	<fieldset>
...
<?php do_action( 'bookyourtravel_show_accommodation_confirm_form_after' ); ?>