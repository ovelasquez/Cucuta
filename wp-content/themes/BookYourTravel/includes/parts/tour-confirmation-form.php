...
do_action( 'bookyourtravel_show_tour_confirm_form_before' ); ?>
<form id="tour-confirmation-form" method="post" action="<?php echo BookYourTravel_Theme_Utils::get_current_page_url(); ?>" class="booking tour-confirmation-form" style="display:none">
	<fieldset>
		<h3><span>03 </span><?php esc_html_e('Confirmation', 'bookyourtravel') ?></h3>
		<div class="text-wrap">
			<p><?php esc_html_e('Thank you. We will get back you with regards your tour booking within 24 hours.', 'bookyourtravel') ?></p>
		</div>				
	...
	?>
		<div class="row">	
			<div class="output one-half">
				<p><?php esc_html_e('Tour', 'bookyourtravel') ?>: 
					<strong class="confirm_tour_title_p"></strong>
				</p>
			</div>
			<div class="output one-half">
				<p><?php esc_html_e('Tour date', 'bookyourtravel') ?>: 
...
<?php do_action( 'bookyourtravel_show_tour_confirm_form_after' );