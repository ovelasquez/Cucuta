...
global $bookyourtravel_tour_helper, $bookyourtravel_theme_globals, $item_class;
...
$posts_per_page = $bookyourtravel_theme_globals->get_tours_archive_posts_per_page();
...
if (isset($page_custom_fields['tour_list_show_featured_only'])) {
	$show_featured_only = $page_custom_fields['tour_list_show_featured_only'][0] == '1' ? true : false;
}

$tour_tags = wp_get_post_terms($page_id, 'tour_tag', array("fields" => "all"));
$tour_tag_ids = array();
if (!is_wp_error($tour_tags) && count($tour_tags) > 0) {
...
<?php
	...
	<section class="<?php echo esc_attr($section_class); ?>">
		...
		<?php endwhile; ?>
<?php
		$tour_results = $bookyourtravel_tour_helper->list_tours($paged, $posts_per_page, $sort_by, $sort_order, $parent_location_id, $tour_type_ids, $tour_tag_ids, array(), $show_featured_only);
?>		
		<div class="deals">
			<script>
