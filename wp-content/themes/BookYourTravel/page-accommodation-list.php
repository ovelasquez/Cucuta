...
global $bookyourtravel_theme_globals, $post, $bookyourtravel_accommodation_helper, $item_class;
...
$posts_per_page = $bookyourtravel_theme_globals->get_accommodations_archive_posts_per_page();
...
if (isset($page_custom_fields['accommodation_list_show_featured_only'])) {
	$show_featured_only = $page_custom_fields['accommodation_list_show_featured_only'][0] == '1' ? true : false;
}
...
if (!is_wp_error($accommodation_tags) && count($accommodation_tags) > 0) {
